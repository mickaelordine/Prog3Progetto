...
public class Server implements Runnable{
    ...
    public Server(Socket socket, Model serverModel) throws IOException {
        ...
        try {
            ...
            e.printStackTrace();
            this.serverModel.addLog("errore mentre inizializzavo i br e bw");
        }
    ...
    public void closeEverything(ServerSocket serverSocket, Socket socket, BufferedWriter bufferedWriter, BufferedReader bufferedReader){
        try{
    ...
    public synchronized int howMuchMails(){
        return 0;
    }
